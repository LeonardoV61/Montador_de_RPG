    ...
    return (
      <div className={styles.containerGeral}>
        <div className={styles.telaLeituraWiki}>
          ...
          {/* Header de Controle (Igual ao topo da Wiki do Mestre) */}
          ...
          <div className={styles.corpoLeitura}>
            ...
            <p className={styles.textoLoreNpc}>
              {npcSelecionado.loreCompleta}
            </p>
          </div>
              ...
              {npcsAvistados
                ...
                .map(npc => (
                  <div key={npc.id} className={`${styles.cardHeroi} ${styles.cardNpc}`}>
                    ...
                    <button 
                      className={`${styles.btnAcaoCard} ${styles.btnVerNpc}`} 
