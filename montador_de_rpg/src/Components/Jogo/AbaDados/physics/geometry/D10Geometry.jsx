...
/**
 * Componente Declarativo React (opcional).
 * Se você utiliza @react-three/fiber, pode usar este componente diretamente no seu canvas.
 */
export default function D10Mesh({ material, ...props }) {
