...
//         if (String(instanciaId).includes('mock')) {

//             await Promise.resolve(); 
            
//             setDados({
//             nome: "Heron (Modo Simulação)",
//             tipo: "Cavaleiro de Testes",
//             atributosAtuais: { 
//                 VIG: 14, CLA: 10, SPI: 12, GD: 15, armadura: 3, gloria: 2 
//             },
//             customizacoes: { VIG_max: 18 }
//             });
//             return; // Para a execução aqui
//         }

//         // 2. 🌐 FLUXO NORMAL DA API
//         try {
//             const res = await entidadeInstanciaService.buscarPorId(instanciaId);
