import { LayoutDashboard, Users, User, Map, Album, Sparkles, PawPrint, BookOpen, Skull, Gem, Backpack, Swords } from "lucide-react";
        ...
        <div>
          ...
          {roleAtiva === "mestre" ? (
            ...
            <div className={styles.menu}>
              ...
              {/* Navega para rota dedicada — sai do menu */}
              <a
                href="#"
                onClick={(e) => { e.preventDefault(); navigate('/criar-personagem'); }}
              >
                <Swords size={18} />
                Criar Personagem
              </a>
